...
public class HangmanGame implements ActionListener {
    ...
    private JPanel createTitlePanel() {
        ...
        ImageIcon image = new ImageIcon(
                new ImageIcon("lib/imageHangman.png").getImage().getScaledInstance(268, 346, Image.SCALE_DEFAULT));
    ...
    private JPanel createDiffPanel() {
        ...
        String text = "Unlike in a normal game of hangman" + "<br>" + "<br>" +
                ...
                "It picks the largest set of words that fit the current guess pattern." + "<br>" + "<br>" +
    ...
    private JPanel createGamePanel() {
        ...
        cheatButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (String s : manager.getDictionary())
